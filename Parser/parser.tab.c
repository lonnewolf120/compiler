...
static const char *const yytname[] =
{
  ...
  "ID", "'+'", "'-'", "'*'", "'/'", "$accept", "stmt", "line", "expr", YY_NULLPTR
};
...
{
       9,     6,    -8,    16,     7,    -8,    -3,    -8,    -8,    -8,
      -8,    -8,    17,    17,    17,    17,    -7,    -7,    -8,    -8
};
...
{
      11,    14,    15,    12,    13,    14,    15,     9,     1,     7,
       1,     2,     3,     2,     3,    16,    17,    18,    19,     8,
       0,     2,    10
};
...
{
       0,     1,     4,     5,    11,    12,    13,     3,     3,     0,
      12,     3,     6,     7,     8,     9,    13,    13,    13,    13
};
...
#line 39 "parser.y"
                        {(yyval.dvar)=(yyvsp[-2].dvar) + (yyvsp[0].dvar);}
