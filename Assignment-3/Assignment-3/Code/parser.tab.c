...
{
       0,    38,    38,    39,    42,    45,    45,    48,    49,    52,
      55,    56,    57,    60,    66,    68,    69,    70,    71,    72,
...
#line 60 "parser.y"
             {
    st.insert((yyvsp[0].cvar), "ID");
    std::cout<< "ID" <<  (yyvsp[0].cvar) << std::endl;  
}
#line 1147 "parser.tab.c"
    break;

  case 15: /* expr: CONST_INT  */
#line 68 "parser.y"
                  {  }
#line 1153 "parser.tab.c"
    break;

  case 16: /* expr: CONST_FLOAT  */
#line 69 "parser.y"
                      {  }
